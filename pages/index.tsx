...
export default function Home() {
  ...
  // here's how you use a mutation in the client. first value in the array is a function that runs the mutation. second is an object with the same stuff that useQuery returns
